...
contract CryptoBroskis is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 2100000000 * 10**3 * 10**3;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "CryptoBroskis";
    string private _symbol = "CBSKI";
...
contract CryptoBroskiICO is CryptoBroskis{
